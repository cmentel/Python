...
def play_game(games, player_one, player_two, player_one_wins, player_two_wins, games_to_play):
    ...
    while games <= games_to_play:
        ...
        player_two_guess = input().strip().upper()
        ...
        if player_two_wins > games_to_play / 2 or player_two_wins > games_to_play / 2:
            break
    ...
    # asks to play again ?
    if play_again(player_one_wins + player_two_wins) == True:
        initialize()
    else:
